    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/student/dorm-payments").hasRole("ADMINSCNS")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/student/meal-info/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.PUT, "/api/student/changeMealNumber").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/exams/info/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/exams/available/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/exams/register/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/exams/unregister/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/student/passed-exams/**").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/professor/subjects").hasRole("PROFESSOR")
                        .requestMatchers(HttpMethod.GET, "/api/professor/subject/students/**").hasRole("PROFESSOR")
                        .requestMatchers(HttpMethod.POST, "/api/professor/grade").hasRole("PROFESSOR")
